...
namespace Engine
{
	...
	ManualResetEvent::ManualResetEvent(bool i_bInitiallySignaled, const wchar_t* i_pName)
	{
	...
	AutoResetEvent::AutoResetEvent(bool i_bInitiallySignaled, const wchar_t* i_pName)
	{
