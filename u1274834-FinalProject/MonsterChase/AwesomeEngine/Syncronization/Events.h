...
namespace Engine
{
	...
	{
	public:
		ManualResetEvent(bool i_bInitiallySignaled = false, const wchar_t* i_pName = nullptr);
		~ManualResetEvent();
	...
	{
	public:
		AutoResetEvent(bool i_bInitiallySignaled = false, const wchar_t* i_pName = nullptr);
		~AutoResetEvent();
